...
<body>
	...
	<header class="header-section">
		<div class="container">
			<!-- Site Logo -->
			<a href="indexDoctor.php" class="site-logo">
			...
			<!-- Main Menu -->
			<ul class="main-menu">
				<li class="active"><a href="indexDoctor.php">Incio</a></li>
				<li><a href="ListarTratamientoCliente.php">Listar tratamiento/cliente</a></li>
	...
	<section class="testimonials-section spad">
		...
		<div class="testimonials-warp">
            <div class="ts-content">
                <h1 style="text-align: justify">Programa diseñado para mejorar la experecia del trabajo</h1>
            </div>
		</div>
	</section>
