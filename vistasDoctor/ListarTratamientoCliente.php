...
<body>
	...
	<header class="header-section">
		<div class="container">
			...
			<!-- Main Menu -->
			<ul class="main-menu">
				<li><a href="indexDoctor.php">Incio</a></li>
				<li class="active"><a href="ListarTratamientoCliente.php">Listar tratamiento/cliente</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-7">
							...
							<p>Doctor <?php echo $_SESSION["nombre"]; ?></p>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="testimonials-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h2>Lista tratamiento cliente</h2>
			</div>
		</div>
            ...
            <div class="ts-content">
                <div align="center">
                    <?php
						...
						$rows = $doctor->idDoctor($_SESSION["idUser"]);

						foreach ($rows as $row) {
		
							$rows2 = $doctor->ListarTratamiento($row['idDoctor']);
							echo "<br>";
							/*foreach ($rows2 as $row2) {
								echo $row2['idDental_treatment'];
							}*/
						}
                    	$numero = 1;
                    echo '<table class="table">';
                            ...
                            foreach ($rows2 as $row2) {
                                echo '<tr>';
                                    ...
                                    echo '</td>';
                                     echo '<td>';
                                     	$rows3 = $doctor->ListarUsuario($row2['User_idUser']);
                                     	foreach ($rows3 as $row3){
                                     		echo $row3['name'];
                                     	} 
                                    echo '</td>';
                                     echo '<td>';
                                     	$rows4 = $doctor->ListarTipoDeuda($row2['type_debt_idtype_debt']);
