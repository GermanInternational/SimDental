...
<section class="testimonials-section spad">
    ...
    <div class="testimonials-warp">
        <div class="ts-content">
                ...
                $rows = $administrador->mostrarDatosModificar($_GET['user']);
                echo "<form method='post' action='opcionUsuario.php'>";
                foreach ($rows as $row){
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputNombre'>Nombre</label>";
                    echo "<input type='text' name='nombre' class='form-control' value='".$row['name']."'>";
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputApelllido'>Apellido</label>";
                    echo "<input type='text' name='apellido' class='form-control'  value='".$row['last_name']."'>";
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputRol'>Tipo documento</label>";
                    if($row['type_document']=='C.C'){
                        echo "<select class='form-control' name='opcionTipoDocumento'>";
                        echo "<option value='C.C'>Cedula ciudadania</option>";
                        echo "<option value='T.I'>Tarjeta de identidad</option>";
                        echo "<option value='C.E'>Cedula extranjeria</option>";
                        echo "</select>";
                    }
                    else if($row['type_document']=='T.I'){
                        echo "<select class='form-control' name='opcionTipoDocumento'>";
                        echo "<option value='T.I'>Tarjeta de identidad</option>";
                        echo "<option value='C.C'>Cedula ciudadania</option>";
                        echo "<option value='C.E'>Cedula extranjeria</option>";
                    ...
                    echo "<label for='exampleInputDocumento'>Documento</label>";
                    echo "<input type='text' name='documento' class='form-control'  value='".$row['document']."'>";
                    echo "</div>";
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputFecha'>Fecha</label>";
                    echo "<input type='date' name='fecha' class='form-control' value='".$row['birth_date']."'>";
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputEmail'>Email</label>";
                    echo "<input type='text' name='email' class='form-control' value='".$row['address']."'>";
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputEmail'>Ciudad</label>";
                    echo "<input type='text' name='ciudad' class='form-control' value='".$row['City']."'>";
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputEmail'>Telefono o celular</label>";
                    echo "<input type='number' name='telefono' class='form-control' value='".$row['phone']."'>";
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputRol'>Rol</label>";
                    if($row['rol']==1){
                        echo "<select class='form-control' name='opcionRol'>";
                        echo "<option value='1'>Administrador</option>";
                        echo "<option value='2'>Doctor</option>";
                        echo "<option value='3'>Secretaria</option>";
                        echo "<option value='4'>Cliente</option>";
                        echo "</select>";
                    }
                    elseif ($row['rol']==2){
                        echo "<select class='form-control' name='opcionRol'>";
                    ...
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputEstado'>Estado</label>";
                    if($row['status']==1){
                        echo "<select class='form-control' name='opcionEstado'>";
                    ...
                    echo "<input type='hidden' name='idUser' class='form-control' value='".$row['idUser']."'>";
                    echo "<input type='hidden' name='modificar' value='Modificar'>";
                }
                echo "</form>";
                ?>
        </div>
