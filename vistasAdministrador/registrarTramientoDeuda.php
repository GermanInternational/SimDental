...
<body>
	...
	<section class="testimonials-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h2>Ingresar el tratamiento</h2>
			</div>
		</div>
		<div class="testimonials-warp">
                <form name="formInicio" method="post">
                    <div class="form-group">
                        <label for="exampleInputNombre">Nombre del tratamiento</label>
                        <input type="text" name="nombre" class="form-control" id="exampleInputNombre" placeholder="Nombre">
                        <small id="exampleInputNombre" class="form-text text-muted">Ingrese el nombre del tratamiento</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputDescription">Descripcion del tratamiento</label>
                        <textarea type="text" name="descripcion" class="form-control" id="exampleInputDescription" placeholder="Descripcion"></textarea>
                        <small id="exampleInputValor" class="form-text text-muted">Ingrese la descripcion del tratamieto</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputestado">Estado</label>
                        <select name="exampleInputestado" class="form-control" id="exampleInputestado" placeholder="Descripcion">
                        ...
                        <small id="exampleInputValor" class="form-text text-muted">Ingrese Estado</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputFecha">Fecha de creacion del tratamiento</label>
                        <input type="date" name="fecha" class="form-control" id="exampleInputFecha" placeholder="Fecha de creacion">
                        <small id="exampleInputFecha" class="form-text text-muted">Ingrese la fecha de creacion del tratamiento</small>
                    </div>
                    <div class="form-group">
                        <?php
                        $administrador = new Administrador();
                        $rows = $administrador->listarClientes();
                        echo "<label for='exampleInputDescription'>Selecciones el cliente</label>";
                        echo "<select class='form-control' name='opcionCliente' id='selectCliente'>";
                        echo "<option value='seleccion'>Seleccion</option>";
                        foreach ($rows as $row){
                            echo "<option value=".$row['idUser'].">".$row['name']." ".$row['last_name']."</option>";
                        }
                        echo "</select>";
                        echo "<small id='exampleInputValor' class='form-text text-muted'>Seleccione el paciente</small>";
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                        $rows = $administrador->listarTipoPlan();
                        echo "<label for='exampleInputDescription'>Selecciones el plan del tratamiento</label>";
                        echo "<select class='form-control' name='opcionTipoPlan' id='selectTipoPlan'>";
                        echo "<option value='seleccion'>Seleccion</option>";
                        foreach ($rows as $row){
                            echo "<option value=".$row['idtype_debt'].">".$row['name']."</option>";
                        }
                        echo "</select>";
                        echo "<small id='exampleInputValor' class='form-text text-muted'>Seleccione el plan del tratamiento</small>";
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                        $rows = $administrador->listarDoctores();
                        echo "<label for='exampleInputDescription'>Selecciones el doctor</label>";
                        echo "<select class='form-control' name='opcionDoctor' id='selectDoctor'>";
                        echo "<option value='seleccion'>Seleccion</option>";
                        foreach ($rows as $row){
                            echo "<option value=".$row['idDoctor'].">".$row['name']." ".$row['last_name']."</option>";
                        }
                        echo "</select>";
                        echo "<small id='exampleInputValor' class='form-text text-muted'>Seleccione el doctor del tratamiento</small>";
                        ?>
                    </div>
                    <button type="submit" class="btn btn-primary" onclick="formularioTratamiento();">Ingresar</button>
                </form>
		</div>
	</section>
