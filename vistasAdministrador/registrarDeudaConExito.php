...
<body>
	...
	<section class="testimonials-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h2>Ingresar tipo de deuda nueva</h2>
			</div>
		</div>
		<div class="testimonials-warp">
                <form name="formInicio" method="post">
                    <div class="form-group">
                        <label for="exampleInputNombre">Nombre del tipo de deuda</label>
                        <input type="text" name="nombre" class="form-control" id="exampleInputNombre" placeholder="Nombre">
                        <small id="exampleInputNombre" class="form-text text-muted">Ingrese el nombre que va a tener ell tipo de deuda</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputValor">Valor del tipo deuda</label>
                        <input type="number" name="valor" class="form-control" id="exampleInputValor" placeholder="Valor">
                        <small id="exampleInputValor" class="form-text text-muted">Ingrese la cantidad del tipo deuda</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputCuota">Valor de la cuota deuda</label>
                        <input type="number" name="cuota" class="form-control" id="exampleInputCuota" placeholder="Cuota">
                        <small id="exampleInputCuota" class="form-text text-muted">Ingrese la cuota</small>
                    </div>
                    <input type="hidden" id="tipoDeudaRegistrar" name="tipoDeudaRegistrar" value="">
                    <button type="submit" class="btn btn-primary" onclick="formularioTipoDeuda();">Ingresar</button>
                </form>
		</div>
	</section>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
	...
	<script>
        alert('El tipo de la deuda fue registrada con exito');
    </script>
