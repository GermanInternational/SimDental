		...
		<div class="testimonials-warp">
            <div class="ts-content">
                ...
                <?php
                    ...
                    $rows = $administrador->listarPlanes();
                    ...
                    echo '<table class="table">';
                            ...
                            foreach ($rows as $row) {
                                echo '<tr>';
                                    echo '<td>';
                                        echo "<input type='checkbox' name='idUser' class='form-check-input' id='exampleCheck1' value=".$row['idtype_debt'].">";
                                    echo '</td>';
                                    echo '<td>';
                                        echo $row['name'];
                                    echo '</td>';
                ...
                echo "<button class='btn btn-primary' onclick='registrarPlan();'>Modificar</button>";
