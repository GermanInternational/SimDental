		...
		<div class="testimonials-warp">
            <div class="ts-content">
                ...
                <?php
                    ...
                    echo '<form action="opcionTratamiento.php" method="post">';
                    echo '<table class="table">';
                            ...
                            foreach ($rows as $row) {
                                echo '<tr>';
                                    echo '<td>';
                                        echo "<input type='checkbox' name='idtratamiento' class='form-check-input' id='exampleCheck1' value=".$row['idDental_treatment'].">";
                                    echo '</td>';
                                    echo '<td>';
                                        echo $row['name'];
                                    echo '</td>';
                                    ...
                                    echo '</td>';
                                    echo '<td>';
                                    	$rows1=$administrador->mostrarDatosUsuarioTratamiento($row['User_idUser']);
                                    	foreach ($rows1 as $row1) {
                                    		 echo $row1['name'];
                                    	}
                                    echo '</td>';
                                    echo '<td>';
                                    	$rows2=$administrador->mostrarDatosDoctorTratamiento($row['Doctor_idDoctor']);                            
                                    	foreach ($rows2 as $row2) {                        		
                                    		 $idusuario=$row2['fk_user'];
                                    		 $rows3=$administrador->mostrarDatosUsuarioTratamiento($idusuario);
                ...
                echo "<input type='hidden' id='tipoDeudaRegistrar' name='modificarTratamiento' value='modificarTratamiento'>";
