	...
	<header class="header-section">
		<div class="container">
			...
			<ul class="main-menu">
				...
				<li class="active"><a href="servicio_partes.php">Servicios</a></li>
	...
	<section class="testimonials-section spad">
		...
		<div class="testimonials-warp">
            <div class="ts-content">
                <h1 style="text-align: justify">Programa diseñado para mejorar la calidad del servicio y cuentas de la persona</h1>
            </div>
		</div>
	</section>
