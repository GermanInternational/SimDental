...
<section class="testimonials-section spad">
    ...
    <div class="testimonials-warp">
        <div class="ts-content">
                ...
                $rows = $administrador->mostrarDatosPlan($_GET['user']);
                echo "<form method='post' action='opcionDeuda.php'>";
                foreach ($rows as $row){
                    ...
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputApelllido'>Valor</label>";
                    echo "<input type='text' name='valor' class='form-control'  value='".$row['value']."'>";
                    echo "</div>";
                    echo "<div class='form-group'>";
                    echo "<label for='exampleInputApelllido'>Cuota</label>";
                    echo "<input type='text' name='cuota' class='form-control'  value='".$row['share']."'>";
                    echo "</div>";
                    ...
                    echo "<input type='hidden' name='idPlan' value='".$row['idtype_debt']."'>";
                    echo "<input type='hidden' name='tipoPlan' value='modificarPlan'>";
                }
                echo "</form>";
                ?>
        </div>
