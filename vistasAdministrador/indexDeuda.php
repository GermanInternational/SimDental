                    ...
                    <form method="post" name="formInicio">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <br>
                                    <button type="button" class="btn btn-primary" onclick="formularioIndexDeuda();">Ingresar</button>
                                    <!--<input type="submit" class="btn btn-primary" value="Ingresar">-->
                                </td>
                            </tr>
                        </table>
                        <input type="hidden" id="retornaFormularioDeuda" name="retornaFormularioDeuda" value="">
                        <input type="hidden" id="retornaFormularioDeudaRegistrar" name="retornaFormularioDeudaRegistrar" value="">
                    </form>
                </div>
            </div>
		</div>
